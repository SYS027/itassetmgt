...
ProductType.create(product_type_id:1,product_type: "Computer")
ProductType.create(product_type_id:2,product_type: "Mobile Devices")
ProductType.create(product_type_id:1,product_type: "Office Accessories")
ProductType.create(product_type_id:1,product_type: "Server")
ProductType.create(product_type_id:1,product_type: "Storage")
